// src/controllers/historico_controller.js
import {
  Agendamento,
  TipoServico,
  Prestador,
 ...
 * Retorna serviços concluídos do contratante (com avaliação se houver)
 */
    ...
    const itens = await Agendamento.findAll({
      ...
      include: [
        ...
        },
        {
          model: Avaliacao,
          as: "avaliacao",
          attributes: ["id", "nota", "comentario", "createdAt"],
          required: false,
        },
        {
          model: Prestador,
...
/**
 * GET /api/historico/status/:id
 * Retorna status atual do agendamento do cliente autenticado
 */
export async function statusCliente(req, res) {
  try {

...
export default function ContatoPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#F89D13]/30 to-[#8F1D14]/10 pt-28 pb-16">
      <div className="max-w-5xl mx-auto px-4">
        {/* Header */}
        <header className="text-center mb-10">
          <h1 className="text-3xl md:text-4xl font-extrabold text-[#2b1304] drop-shadow-sm">
            Contato
          </h1>
          <p className="text-sm md:text-base text-gray-800 mt-2 max-w-2xl mx-auto">
            ...
            a evolução do projeto <span className="font-semibold">Marido de Aluguel</span>.
          </p>
        </header>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {team.map((m) => (
            <article
              key={m.linkedin}
              className="bg-white/95 backdrop-blur-md rounded-2xl shadow-md p-6 flex flex-col items-center text-center transition hover:shadow-lg"
            >
              {/* Avatar */}
        ...
        {/* Créditos acadêmicos + logos */}
        <section className="mt-12">
          <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-md p-6 md:p-7 flex flex-col md:flex-row items-center md:items-center gap-6">
            {/* Bloco Fatec */}
            <div className="flex-1 flex items-center gap-4">
              <div className="relative h-12 w-32 md:h-14 md:w-40">
                <Image
                  src="/logos/fatec-ipiranga.png"
              ...
              <div>
                <p className="text-sm text-gray-800">
                  ...
                  pelos alunos da <span className="font-semibold">Fatec Ipiranga</span>.
                </p>
                <p className="text-xs text-gray-600 mt-1">
                  Orientador de TCC: <span className="font-semibold">Carlos Henrique Verissimo Pereira</span>.
                </p>
              </div>
            </div>

            {/* Bloco Smart Solutions+ */}
            <div className="flex-1 flex items-center gap-4 md:justify-end">
              ...
              <div className="text-xs md:text-sm text-gray-800">
                ...
                <p>Parceria tecnológica na plataforma Marido de Aluguel.</p>
              </div>
            </div>
          </div>
        </section>
